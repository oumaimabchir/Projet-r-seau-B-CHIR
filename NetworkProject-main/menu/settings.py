...
#background_of_menu  = pg.image.load("./NetworkProject-main/assets/graphics/background.jpeg")
chemin=os.path.join( "NetworkProject-main", "assets", "graphics", "background.jpeg")
background_of_menu = pg.image.load(chemin)
bouton_orange = pg.image.load(PATH + "bouton_orange.png")
bouton_orange_souris = pg.image.load(PATH + "bouton_orange_souris.png")
bouton_rouge = pg.image.load(PATH + "bouton_rouge.png")
pause_image = pg.image.load(PATH + "pause_image.png")
rendering_image = pg.image.load(PATH + "rendering_image.png")
